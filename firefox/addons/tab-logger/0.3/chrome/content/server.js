...
const pref = srvPref.getBranch('extensions.tablogger.');


function REPL() {};
loader.loadSubScript('chrome://tablogger/content/repl.js', REPL.prototype);
